...
IUSE="bindist eme-free +gmp-autoupdate hardened hwaccel jack +screenshot selinux test wayland"
...
src_configure() {
	...
	use wayland && mozconfig_annotate 'Enable EXPERIMENTAL Wayland support' --enable-default-toolkit=cairo-gtk3-wayland
