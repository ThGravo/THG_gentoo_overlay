...
IUSE="contrib cuda +eigen examples ffmpeg gdal gphoto2 gstreamer gtk \
	...
	+python qt4 qt5 sfm testprograms threads tiff vaapi v4l vtk webp xine"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-3.1.0-cuda80.patch
)
...
src_configure() {
	...
	# ===================================================
		...
		-DCUDA_ARCH_BIN="3.0 3.5 5.2"
		-DCUDA_ARCH_PTX="5.2"
		-DBUILD_opencv_sfm=$(usex sfm ON OFF)
	)
